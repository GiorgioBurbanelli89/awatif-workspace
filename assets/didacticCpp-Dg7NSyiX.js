...
let __tla = (async () => {
  ...
  it = function(p, a, m) {
    ...
    if (a && a.length > 0) {
      ...
      const W = document.querySelector("meta[property=csp-nonce]"), C = (W == null ? void 0 : W.nonce) || (W == null ? void 0 : W.getAttribute("nonce"));
      h = Promise.allSettled(a.map((z) => {
        if (z = at(z), z in _r) return;
        _r[z] = true;
        const q = z.endsWith(".css"), te = q ? '[rel="stylesheet"]' : "";
        if (document.querySelector(`link[href="${z}"]${te}`)) return;
        const V = document.createElement("link");
        if (V.rel = q ? "stylesheet" : st, q || (V.as = "script"), V.crossOrigin = "", V.href = z, C && V.setAttribute("nonce", C), document.head.appendChild(V), q) return new Promise(($, ee) => {
          V.addEventListener("load", $), V.addEventListener("error", () => ee(new Error(`Unable to preload CSS for ${z}`)));
        });
      }));
    }
    function g(W) {
      ...
      if (C.payload = W, window.dispatchEvent(C), !C.defaultPrevented) throw W;
    }
    return h.then((W) => {
      for (const C of W || []) C.status === "rejected" && g(C.reason);
      return p().catch(g);
    });
  };
  Le = async function(f = {}) {
    ...
    (function() {
      ...
      function e(u) {
        u = u.split("-")[0];
        for (var E = u.split(".").slice(0, 3); E.length < 3; ) E.push("00");
        return E = E.map((D, U, y) => D.padStart(2, "0")), E.join("");
      }
      var r = (u) => [
        u / 1e4 | 0,
        (u / 100 | 0) % 100,
    ...
    var a = f, m = !!globalThis.window, h = !!globalThis.WorkerGlobalScope, g = ((_b = (_a = globalThis.process) == null ? void 0 : _a.versions) == null ? void 0 : _b.node) && ((_c = globalThis.process) == null ? void 0 : _c.type) != "renderer", W = !m && !g && !h;
    if (g) {
      const { createRequire: e } = await it(() => import("./__vite-browser-external-D7Ct-6yo.js").then((r) => r._), []);
      var C = e(import.meta.url);
    }
    var z = "./this.program", q = import.meta.url, te = "";
    function V(e) {
      return a.locateFile ? a.locateFile(e, te) : te + e;
    }
    var $, ee;
    if (g) {
      ...
      var w = C("fs");
      q.startsWith("file:") && (te = C("path").dirname(C("url").fileURLToPath(q)) + "/"), ee = (r) => {
        r = L(r) ? new URL(r) : r;
    ...
    function X() {
      if (!T) {
        ...
        (r != 34821223 || t != 2310721022) && k(`Stack overflow! Stack cookie has been overwritten at ${He(e)}, expected hex dwords 0x89BACDFE and 0x2135467, but received ${He(t)} ${He(r)}`), v[0] != 1668509029 && k("Runtime error: The application has corrupted its heap memory area (address zero)!");
      }
    }
    (() => {
    ...
    function ce(e) {
      Object.getOwnPropertyDescriptor(a, e) || Object.defineProperty(a, e, {
        ...
        get() {
          ...
          M(e) && (r += ". Alternatively, forcing filesystem support (-sFORCE_FILESYSTEM) can export this for you"), k(r);
        }
      });
    }
    var pe, de, Z, re, fe, v, I, se = false;
    function Q() {
      var e = qe.buffer;
      Z = new Int8Array(e), a.HEAPU8 = re = new Uint8Array(e), fe = new Int32Array(e), a.HEAPU32 = v = new Uint32Array(e), a.HEAPF64 = new Float64Array(e), I = new BigInt64Array(e), new BigUint64Array(e);
    }
    ...
    function me() {
      d(!se), se = true, X(), !a.noFSInit && !n.initialized && n.init(), Ce.__wasm_call_ctors(), n.ignorePermissions = false;
    }
    function _e() {
    ...
    function k(e) {
      var _a2;
      (_a2 = a.onAbort) == null ? void 0 : _a2.call(a, e), e = "Aborted(" + e + ")", S(e), T = true;
    ...
    var J;
    function ie() {
      return a.locateFile ? V("deform.wasm") : new URL("/awatif-workspace/assets/deform-DUYh9v5r.wasm", import.meta.url).href;
    }
    function R(e) {
      if (e == J && _) return new Uint8Array(_);
      if (ee) return ee(e);
    ...
    async function Y(e, r) {
      try {
        var t = await j(e), o = await WebAssembly.instantiate(t, r);
        return o;
      } catch (s) {
        S(`failed to asynchronously prepare wasm: ${s}`), L(e) && S(`warning: Loading from a file URI (${e}) is not supported in most browsers. See https://emscripten.org/docs/getting_started/FAQ.html#how-do-i-run-a-local-webserver-for-testing-why-does-my-program-stall-in-downloading-or-preparing`), k(s);
      }
    }
    ...
    var Ie = (e) => {
      ...
      xe.shown || (xe.shown = {}), xe.shown[e] || (xe.shown[e] = 1, g && (e = "warning: " + e), S(e));
      ...
      for (var i = ""; r < s; ) {
        ...
        if ((l & 240) == 224 ? l = (l & 15) << 12 | c << 6 | u : ((l & 248) != 240 && xe("Invalid UTF-8 leading byte " + He(l) + " encountered when deserializing a UTF-8 string in wasm memory to a JS string!"), l = (l & 7) << 18 | c << 12 | u << 6 | e[r++] & 63), l < 65536) i += String.fromCharCode(l);
          ...
          var E = l - 65536;
          i += String.fromCharCode(55296 | E >> 10, 56320 | E & 1023);
        }
      }
      return i;
    }, Be = (e, r, t) => (d(typeof e == "number", `UTF8ToString expects a number (got ${typeof e})`), e ? Re(re, e, r) : ""), Sr = (e, r, t, o) => k(`Assertion failed: ${Be(e)}, at: ` + [
    ...
    var Pr = (e, r, t) => {
    ...
    }, Ar = () => k("native code called abort()"), ar = (e, r, t, o) => {
      ...
      return r[t] = 0, t - s;
    }, We = (e, r, t) => (d(typeof t == "number", "stringToUTF8(str, outPtr, maxBytesToWrite) is missing the third parameter that specifies the length of the output buffer!"), ar(e, re, r, t)), Ke = (e) => {
      ...
      var s = (/* @__PURE__ */ new Date()).getFullYear(), i = new Date(s, 0, 1), l = new Date(s, 6, 1), c = i.getTimezoneOffset(), u = l.getTimezoneOffset(), E = Math.max(c, u);
      v[e >> 2] = E * 60, fe[r >> 2] = +(c != u);
      var D = (b) => {
        var ae = b >= 0 ? "-" : "+", ye = Math.abs(b), ge = String(Math.floor(ye / 60)).padStart(2, "0"), Ee = String(ye % 60).padStart(2, "0");
        return `UTC${ae}${ge}${Ee}`;
      }, U = D(c), y = D(u);
      d(U), d(y), d(Ke(U) <= 16, `timezone name truncated to fit in TZNAME_MAX (${U})`), d(Ke(y) <= 16, `timezone name truncated to fit in TZNAME_MAX (${y})`), u < c ? (We(U, t, 17), We(y, o, 17)) : (We(U, o, 17), We(y, t, 17));
...
`));
      ...
      default_tty_ops: {
        ...
        put_char(e, r) {
          r === null || r === 10 ? (O(Re(e.output)), e.output = []) : r != 0 && e.output.push(r);
        },
        fsync(e) {
          var _a2;
          ((_a2 = e.output) == null ? void 0 : _a2.length) > 0 && (O(Re(e.output)), e.output = []);
        },
        ioctl_tcgets(e) {
          return {
            c_iflag: 25856,
      ...
      default_tty1_ops: {
        put_char(e, r) {
          r === null || r === 10 ? (S(Re(e.output)), e.output = []) : r != 0 && e.output.push(r);
        },
        fsync(e) {
          var _a2;
          ((_a2 = e.output) == null ? void 0 : _a2.length) > 0 && (S(Re(e.output)), e.output = []);
        }
      }
    }, lr = (e) => {
      ...
      var u = r ? Ne.resolve(B.join2(e, r)) : e, E = xr(`cp ${u}`);
      Wr(E);
      try {
        var D = t;
    ...
    }, jr = (e, r, t, o, s, i, l, c, u, E) => {
      fr(e, r, t, o, s, c, u, E).then(i).catch(l);
    }, n = {
      root: null,
      mounts: [],
      devices: {},
      ...
      lookupPath(e, r = {}) {
        ...
        e: for (var t = 0; t < 40; t++) {
          for (var o = e.split("/").filter((E) => !!E), s = n.root, i = "/", l = 0; l < o.length; l++) {
            var c = l === o.length - 1;
            if (c && r.parent) break;
            if (o[l] !== ".") {
              if (o[l] === "..") {
              ...
              try {
                ...
                if ((E == null ? void 0 : E.errno) === 44 && c && r.noent_okay) return {
                  path: i
                };
                throw E;
              }
      ...
      rename(e, r) {
        ...
        var E = n.lookupNode(c, s), D = Ne.relative(e, o);
        ...
        if (E !== U) {
          var y = n.isDir(E.mode), b = n.mayDelete(c, s, y);
          if (b) throw new n.ErrnoError(b);
          if (b = U ? n.mayDelete(u, i, y) : n.mayCreate(u, i), b) throw new n.ErrnoError(b);
          if (!c.node_ops.rename) throw new n.ErrnoError(63);
          if (n.isMountpoint(E) || U && n.isMountpoint(U)) throw new n.ErrnoError(10);
          if (u !== c && (b = n.nodePermissions(c, "w"), b)) throw new n.ErrnoError(b);
          n.hashRemoveNode(E);
          try {
            c.node_ops.rename(E, u, i), E.parent = u;
          } catch (ae) {
            throw ae;
          } finally {
            n.hashAddNode(E);
      ...
      readFile(e, r = {}) {
        ...
        return n.read(t, i, 0, s, 0), r.encoding === "utf8" && (i = Re(i)), n.close(t), i;
      },
      writeFile(e, r, t = {}) {
        t.flags = t.flags || 577;
        var o = n.open(e, t.flags, t.mode);
        typeof r == "string" && (r = new Uint8Array(er(r))), ArrayBuffer.isView(r) ? n.write(o, r, 0, r.byteLength, void 0, t.canOwn) : k("Unsupported data type"), n.close(o);
      },
      cwd: () => n.currentPath,
      chdir(e) {
        var r = n.lookupPath(e, {
      ...
      createFile(e, r, t, o, s) {
        var i = B.join2(typeof e == "string" ? e : n.getPath(e), r), l = rr(o, s);
        return n.create(i, l);
      },
      createDataFile(e, r, t, o, s, i) {
        ...
        if (t) {
          if (typeof t == "string") {
            for (var E = new Array(t.length), D = 0, U = t.length; D < U; ++D) E[D] = t.charCodeAt(D);
            t = E;
          }
          n.chmod(u, c | 146);
          var y = n.open(u, 577);
          n.write(y, t, 0, t.length, 0, i), n.close(y), n.chmod(u, c);
        }
      },
      createDevice(e, r, t, o) {
        var _a2;
        var s = B.join2(typeof e == "string" ? e : n.getPath(e), r), i = rr(!!t, !!o);
        ...
        return n.registerDevice(l, {
          ...
          read(c, u, E, D, U) {
            for (var y = 0, b = 0; b < D; b++) {
              ...
              if (ae === void 0 && y === 0) throw new n.ErrnoError(6);
              if (ae == null) break;
              y++, u[E + b] = ae;
            }
          ...
          write(c, u, E, D, U) {
            for (var y = 0; y < D; y++) try {
              o(u[E + y]);
            } catch {
              throw new n.ErrnoError(29);
            }
            return D && (c.node.mtime = c.node.ctime = Date.now()), y;
          }
        }), n.mkdev(s, i, l);
      },
      forceLoadFile(e) {
      ...
      createLazyFile(e, r, t, o, s) {
        class i {
          ...
          get(y) {
            if (!(y > this.length - 1 || y < 0)) {
              var b = y % this.chunkSize, ae = y / this.chunkSize | 0;
              return this.getter(ae)[b];
            }
          }
          setDataGetter(y) {
            this.getter = y;
          ...
          cacheLength() {
            ...
            y.open("HEAD", t, false), y.send(null), y.status >= 200 && y.status < 300 || y.status === 304 || k("Couldn't load " + t + ". Status: " + y.status);
            var b = Number(y.getResponseHeader("Content-length")), ae, ye = (ae = y.getResponseHeader("Accept-Ranges")) && ae === "bytes", ge = (ae = y.getResponseHeader("Content-Encoding")) && ae === "gzip", Ee = 1024 * 1024;
            ye || (Ee = b);
            var Fe = (Ae, Ue) => {
              Ae > Ue && k("invalid range (" + Ae + ", " + Ue + ") or no bytes requested!"), Ue > b - 1 && k("only " + b + " bytes available! programmer error!");
              var he = new XMLHttpRequest();
              return he.open("GET", t, false), b !== Ee && he.setRequestHeader("Range", "bytes=" + Ae + "-" + Ue), he.responseType = "arraybuffer", he.overrideMimeType && he.overrideMimeType("text/plain; charset=x-user-defined"), he.send(null), he.status >= 200 && he.status < 300 || he.status === 304 || k("Couldn't load " + t + ". Status: " + he.status), he.response !== void 0 ? new Uint8Array(he.response || []) : er(he.responseText || "");
            }, Ve = this;
            Ve.setDataGetter((Ae) => {
              var Ue = Ae * Ee, he = (Ae + 1) * Ee - 1;
              return he = Math.min(he, b - 1), typeof Ve.chunks[Ae] > "u" && (Ve.chunks[Ae] = Fe(Ue, he)), typeof Ve.chunks[Ae] > "u" && k("doXHR failed!"), Ve.chunks[Ae];
            }), (ge || !b) && (Ee = b = 1, b = this.getter(0).length, Ee = b, O("LazyFiles on gzip forces download of the whole file when length is accessed")), this._length = b, this._chunkSize = Ee, this.lengthKnown = true;
          }
          get length() {
        ...
        if (globalThis.XMLHttpRequest) {
          h || k("Cannot do synchronous binary XHRs outside webworkers in modern browsers. Use --embed-file or --preload-file in emcc");
          var l = new i(), c = {
            isDevice: false,
            contents: l
          };
        ...
        var E = {};
        for (const [U, y] of Object.entries(u.stream_ops)) E[U] = (...b) => (n.forceLoadFile(u), y(...b));
        function D(U, y, b, ae, ye) {
          var ge = U.node.contents;
          if (ye >= ge.length) return 0;
          var Ee = Math.min(ge.length - ye, ae);
          if (d(Ee >= 0), ge.slice) for (var Fe = 0; Fe < Ee; Fe++) y[b + Fe] = ge[ye + Fe];
          else for (var Fe = 0; Fe < Ee; Fe++) y[b + Fe] = ge.get(ye + Fe);
          return Ee;
        }
        return E.read = (U, y, b, ae, ye) => (n.forceLoadFile(u), D(U, y, b, ae, ye)), E.mmap = (U, y, b, ae, ye) => {
          n.forceLoadFile(u);
          var ge = lr();
      ...
      writeStat(e, r) {
        v[e >> 2] = r.dev, v[e + 4 >> 2] = r.mode, v[e + 8 >> 2] = r.nlink, v[e + 12 >> 2] = r.uid, v[e + 16 >> 2] = r.gid, v[e + 20 >> 2] = r.rdev, I[e + 24 >> 3] = BigInt(r.size), fe[e + 32 >> 2] = 4096, fe[e + 36 >> 2] = r.blocks;
        var t = r.atime.getTime(), o = r.mtime.getTime(), s = r.ctime.getTime();
        return I[e + 40 >> 3] = BigInt(Math.floor(t / 1e3)), v[e + 48 >> 2] = t % 1e3 * 1e3 * 1e3, I[e + 56 >> 3] = BigInt(Math.floor(o / 1e3)), v[e + 64 >> 2] = o % 1e3 * 1e3 * 1e3, I[e + 72 >> 3] = BigInt(Math.floor(s / 1e3)), v[e + 80 >> 2] = s % 1e3 * 1e3 * 1e3, I[e + 88 >> 3] = BigInt(r.ino), 0;
      },
      writeStatFs(e, r) {
        v[e + 4 >> 2] = r.bsize, v[e + 60 >> 2] = r.bsize, I[e + 8 >> 3] = BigInt(r.blocks), I[e + 16 >> 3] = BigInt(r.bfree), I[e + 24 >> 3] = BigInt(r.bavail), I[e + 32 >> 3] = BigInt(r.files), I[e + 40 >> 3] = BigInt(r.ffree), v[e + 48 >> 2] = r.fsid, v[e + 64 >> 2] = r.flags, v[e + 56 >> 2] = r.namelen;
      },
      doMsync(e, r, t, o, s) {
        if (!n.isFile(r.node.mode)) throw new n.ErrnoError(43);
        if (o & 2) return 0;
        var i = re.slice(e, e + t);
        n.msync(r, i, s, t, o);
      },
      getStreamFromFD(e) {
    ...
    function Zr(e, r, t, o) {
      ...
      try {
        ...
        var s = Ge.getStreamFromFD(e);
        return n.llseek(s, r, t), I[o >> 3] = BigInt(s.position), s.getdents && r === 0 && t === 0 && (s.getdents = null), 0;
      } catch (i) {
    ...
    var ur = A("_fflush"), mr = A("_strerror"), tr = A("_emscripten_stack_get_end"), hr = A("_emscripten_stack_init"), qe = A("wasmMemory");
    function nt(e) {
    ...
    function nr() {
      ...
      function e() {
        var _a2;
        d(!vr), vr = true, a.calledRun = true, !T && (me(), pe == null ? void 0 : pe(a), (_a2 = a.onRuntimeInitialized) == null ? void 0 : _a2.call(a), ne("onRuntimeInitialized"), d(!a._main, 'compiled without a main, but one is present. if you added it from JS, use Module["onRuntimeInitialized"]'), _e());
      }
    ...
    var Ce;
    Ce = await Ze(), nr(), se ? p = a : p = new Promise((e, r) => {
      pe = e, de = r;
    });
  ...
  dt = function(f, p, a, m) {
    ...
    const h = [], g = we(f.flat(), Float64Array, K.HEAPF64);
    h.push(g);
    const W = p.flat(), C = we(W, Uint32Array, K.HEAPU32);
    h.push(C);
    const z = p.map((N) => N.length), q = we(z, Uint32Array, K.HEAPU32);
    h.push(q);
    const te = a.supports ? Array.from(a.supports.keys()) : [], V = a.supports ? Array.from(a.supports.values()).flat().map((N) => N ? 1 : 0) : [], $ = we(te, Uint32Array, K.HEAPU32);
    h.push($);
    const ee = we(V, Uint8Array, K.HEAPU8);
    h.push(ee);
    const w = a.loads ? Array.from(a.loads.keys()) : [], O = a.loads ? Array.from(a.loads.values()).flat() : [], S = we(w, Uint32Array, K.HEAPU32);
    h.push(S);
    const _ = we(O, Float64Array, K.HEAPF64);
    h.push(_);
    const T = (N) => {
      const Se = N ? Array.from(N.keys()) : [], Ze = N ? Array.from(N.values()) : [], Ie = we(Se, Uint32Array, K.HEAPU32);
      h.push(Ie);
      const ze = we(Ze, Float64Array, K.HEAPF64);
      return h.push(ze), {
        keysPtr: Ie,
        valuesPtr: ze,
        size: Se.length
      };
    }, d = T(m.elasticities), L = T(m.elasticitiesOrthogonal), x = T(m.areas), X = T(m.momentsOfInertiaZ), ne = T(m.momentsOfInertiaY), A = T(m.shearModuli), oe = T(m.torsionalConstants), M = T(m.thicknesses), le = T(m.poissonsRatios);
    T(m.shearAreasY), T(m.shearAreasZ);
    const ce = m.rigidOffsets ? Array.from(m.rigidOffsets.keys()) : [], pe = m.rigidOffsets ? Array.from(m.rigidOffsets.values()).flat() : [], de = we(ce, Uint32Array, K.HEAPU32);
    h.push(de);
    const Z = we(pe, Float64Array, K.HEAPF64);
    h.push(Z);
    const re = m.momentReleases ? Array.from(m.momentReleases.keys()) : [], fe = m.momentReleases ? Array.from(m.momentReleases.values()).flat().map((N) => N ? 1 : 0) : [], v = we(re, Uint32Array, K.HEAPU32);
    h.push(v);
    const I = we(fe, Uint8Array, K.HEAPU8);
    h.push(I);
    const se = K._malloc(4);
    h.push(se);
    const Q = K._malloc(4);
    h.push(Q);
    const ve = K._malloc(4);
    h.push(ve);
    const me = K._malloc(4);
    h.push(me), K._deform(g, f.length, C, W.length, q, p.length, $, ee, te.length, S, _, w.length, d.keysPtr, d.valuesPtr, d.size, x.keysPtr, x.valuesPtr, x.size, X.keysPtr, X.valuesPtr, X.size, ne.keysPtr, ne.valuesPtr, ne.size, A.keysPtr, A.valuesPtr, A.size, oe.keysPtr, oe.valuesPtr, oe.size, M.keysPtr, M.valuesPtr, M.size, le.keysPtr, le.valuesPtr, le.size, L.keysPtr, L.valuesPtr, L.size, se, Q, ve, me);
    const _e = K.HEAPU32[se / 4], k = K.HEAPU32[Q / 4], F = K.HEAPU32[ve / 4], J = K.HEAPU32[me / 4], ie = new Float64Array(K.HEAPF64.buffer, _e, k), R = new Float64Array(K.HEAPF64.buffer, F, J), j = /* @__PURE__ */ new Map();
    for (let N = 0; N < k; N += 7) {
      const Se = ie[N];
      j.set(Se, Array.from(ie.slice(N + 1, N + 7)));
    }
    const Y = /* @__PURE__ */ new Map();
    for (let N = 0; N < J; N += 7) {
      const Se = R[N];
      Y.set(Se, Array.from(R.slice(N + 1, N + 7)));
    }
    return _e && h.push(_e), F && h.push(F), h.forEach((N) => K._free(N)), {
      deformations: j,
      reactions: Y
    };
  };
  function we(f, p, a) {
    const m = new p(f), h = K._malloc(m.length * m.BYTES_PER_ELEMENT);
  ...
  ft = function(f, p, a, m, h = 10) {
    ...
    const g = [], W = Me(f.flat(), Float64Array, H.HEAPF64);
    g.push(W);
    const C = p.flat(), z = Me(C, Uint32Array, H.HEAPU32);
    g.push(z);
    const q = p.map((F) => F.length), te = Me(q, Uint32Array, H.HEAPU32);
    g.push(te);
    const V = a.supports ? Array.from(a.supports.keys()) : [], $ = a.supports ? Array.from(a.supports.values()).flat().map((F) => F ? 1 : 0) : [], ee = Me(V, Uint32Array, H.HEAPU32);
    g.push(ee);
    const w = Me($, Uint8Array, H.HEAPU8);
    g.push(w);
    const O = (F) => {
      const J = F ? Array.from(F.keys()) : [], ie = F ? Array.from(F.values()) : [], R = Me(J, Uint32Array, H.HEAPU32);
      g.push(R);
      const j = Me(ie, Float64Array, H.HEAPF64);
      return g.push(j), {
        keysPtr: R,
        valuesPtr: j,
        size: J.length
      };
    }, S = O(m.elasticities), _ = O(m.areas), T = O(m.momentsOfInertiaZ), d = O(m.momentsOfInertiaY), L = O(m.shearModuli), x = O(m.torsionalConstants), X = O(m.densities), ne = H._malloc(4);
    g.push(ne);
    const A = H._malloc(4);
    g.push(A);
    const oe = H._malloc(4);
    g.push(oe);
    const M = H._malloc(4);
    g.push(M);
    const le = H._malloc(4);
    g.push(le);
    const ce = H._malloc(4);
    g.push(ce);
    const pe = H._malloc(4);
    g.push(pe);
    const de = H._malloc(4);
    g.push(de), H._modal(W, f.length, z, C.length, te, p.length, ee, w, V.length, S.keysPtr, S.valuesPtr, S.size, _.keysPtr, _.valuesPtr, _.size, T.keysPtr, T.valuesPtr, T.size, d.keysPtr, d.valuesPtr, d.size, L.keysPtr, L.valuesPtr, L.size, x.keysPtr, x.valuesPtr, x.size, X.keysPtr, X.valuesPtr, X.size, h, ne, A, oe, M, le, ce, pe, de);
    const Z = H.HEAPU32[ne / 4], re = H.HEAPU32[A / 4], fe = H.HEAPU32[oe / 4], v = H.HEAPU32[M / 4], I = H.HEAPU32[le / 4], se = H.HEAPU32[ce / 4], Q = H.HEAPU32[pe / 4], ve = H.HEAPU32[de / 4];
    let me = [], _e = [], k = [];
    if (re > 0 && Z) {
      const F = new Float64Array(H.HEAPF64.buffer, Z, re);
      me = Array.from(F), g.push(Z);
    }
    if (v > 0 && I > 0 && fe) {
      const F = new Float64Array(H.HEAPF64.buffer, fe, v * I);
      for (let J = 0; J < v; J++) _e.push(Array.from(F.slice(J * I, (J + 1) * I)));
      g.push(fe);
    }
    if (Q > 0 && ve > 0 && se) {
      const F = new Float64Array(H.HEAPF64.buffer, se, Q * ve);
      for (let J = 0; J < Q; J++) k.push(Array.from(F.slice(J * ve, (J + 1) * ve)));
      g.push(se);
    }
    return g.forEach((F) => H._free(F)), {
      frequencies: me,
      modeShapes: _e,
      massParticipation: k
    };
  ...
  function Me(f, p, a) {
    const m = new p(f), h = H._malloc(m.length * m.BYTES_PER_ELEMENT);
    return a.set(m, h / m.BYTES_PER_ELEMENT), h;
  }
  await Le();
  const Pe = await Le();
  ut = function(f) {
    const { nodes: p, elements: a, E: m, nu: h, gamma: g, c: W, phi: C, thickness: z = 1, supports: q, surcharge: te = 0, surfaceYThreshold: V = -1e10 } = f, $ = [], ee = p.flat(), w = lt(ee);
    $.push(w);
    const O = a.flat(), S = Er(O);
    $.push(S);
    const _ = [];
    for (const M of q) _.push(M.node, M.fixX ? 1 : 0, M.fixY ? 1 : 0);
    const T = Er(_);
    $.push(T);
    const d = a.length, L = p.length, x = Pe._slopeAllocDouble(d);
    $.push(x);
    const X = Pe._slopeAllocDouble(L * 2);
    $.push(X);
    const ne = Pe._slopeStabilitySolver(w, L, S, d, m, h, g, W, C, z, T, q.length, te, V, x, X), A = [];
    for (let M = 0; M < d; M++) A.push(Pe.HEAPF64[x / 8 + M]);
    const oe = [];
    for (let M = 0; M < L; M++) oe.push([
      Pe.HEAPF64[X / 8 + 2 * M],
      Pe.HEAPF64[X / 8 + 2 * M + 1]
    ]);
    return $.forEach((M) => Pe._free(M)), {
      fos: ne,
      plasticStrain: A,
      displacements: oe
    };
  ...
  mt = function(f) {
    ...
    p.push(h);
    let g = [], W = 0;
    f.elements && f.elements.length > 0 && (W = f.elements.length, g = f.elements.flat());
    const C = Ye(g.length > 0 ? g : [
      0
    ], Int32Array, ue.HEAPU32);
    p.push(C);
    let z = [], q = 0;
    f.bcs && f.bcs.length > 0 && (q = f.bcs.length, z = f.bcs.flatMap((R) => [
      R.node,
      R.dof,
      R.value
    ]));
    const te = Ye(z.length > 0 ? z : [
      0
    ], Float64Array, ue.HEAPF64);
    p.push(te);
    let V = [], $ = 0;
    f.pointLoads && f.pointLoads.length > 0 && ($ = f.pointLoads.length, V = f.pointLoads.flatMap((R) => [
      R.node,
      R.dof,
      R.value
    ]));
    const ee = Ye(V.length > 0 ? V : [
      0
    ], Float64Array, ue.HEAPF64);
    p.push(ee);
    const w = f.meshLx ?? 0, O = f.meshLy ?? 0, S = f.meshNx ?? 0, _ = f.meshNy ?? 0, d = {
      none: 0,
      "simply-supported": 1,
      clamped: 2
    ...
    const ne = Ye(x.length > 0 ? x : [
      0
    ], Float64Array, ue.HEAPF64);
    p.push(ne);
    const A = ue._malloc(4);
    p.push(A);
    const oe = ue._malloc(4);
    p.push(oe);
    const M = ue._malloc(4);
    p.push(M);
    const le = ue._malloc(4);
    p.push(le), ue._plate_q4_solve(h, m, C, W, f.E, f.nu, f.thickness, te, q, f.pressure ?? 0, ee, $, w, O, S, _, d, L, ne, X, A, oe, M, le);
    const ce = ue.HEAPU32[A / 4], pe = ue.HEAPU32[oe / 4], de = ue.HEAPU32[M / 4], Z = ue.HEAPU32[le / 4], re = new Float64Array(ue.HEAPF64.buffer, ce, pe), fe = re[0], v = re[1], I = [];
    let se = 0;
    for (let R = 0; R < fe; R++) {
      const j = 2 + R * 5, Y = {
        x: re[j],
      ...
      I.push(Y), Math.abs(Y.w) > Math.abs(se) && (se = Y.w);
    }
    const Q = new Float64Array(ue.HEAPF64.buffer, de, Z), ve = [];
    let me = 0, _e = 0, k = 0, F = 0, J = 0;
    for (let R = 0; R < v; R++) {
      const j = R * 9, Y = {
        nodes: [
          Q[j],
      ...
      ve.push(Y), Math.abs(Y.Mxx) > Math.abs(me) && (me = Y.Mxx), Math.abs(Y.Myy) > Math.abs(_e) && (_e = Y.Myy), Math.abs(Y.Mxy) > Math.abs(k) && (k = Y.Mxy), Math.abs(Y.Qx) > Math.abs(F) && (F = Y.Qx), Math.abs(Y.Qy) > Math.abs(J) && (J = Y.Qy);
    }
    let ie;
    if (w > 0 && O > 0) {
      const R = w / 2, j = O / 2;
      let Y = 1 / 0;
      for (const N of I) {
        const Se = Math.hypot(N.x - R, N.y - j);
        Se < Y && (Y = Se, ie = N.w);
      }
    }
    return ce && p.push(ce), de && p.push(de), p.forEach((R) => ue._free(R)), {
      nodeResults: I,
      elementResults: ve,
      maxW: se,
      maxMxx: me,
  ...
  ht = function(f, p, a, m) {
    ...
    const h = [], g = ke(f.flat(), Float64Array, G.HEAPF64);
    h.push(g);
    const W = p.flat(), C = ke(W, Uint32Array, G.HEAPU32);
    h.push(C);
    const z = p.map((ie) => ie.length), q = ke(z, Uint32Array, G.HEAPU32);
    h.push(q);
    const te = a.supports ? Array.from(a.supports.keys()) : [], V = a.supports ? Array.from(a.supports.values()).flat().map((ie) => ie ? 1 : 0) : [], $ = ke(te, Uint32Array, G.HEAPU32);
    h.push($);
    const ee = ke(V, Uint8Array, G.HEAPU8);
    h.push(ee);
    const w = a.loads ? Array.from(a.loads.keys()) : [], O = a.loads ? Array.from(a.loads.values()).flat() : [], S = ke(w, Uint32Array, G.HEAPU32);
    h.push(S);
    const _ = ke(O, Float64Array, G.HEAPF64);
    h.push(_);
    const T = (ie) => {
      const R = ie ? Array.from(ie.keys()) : [], j = ie ? Array.from(ie.values()) : [], Y = ke(R, Uint32Array, G.HEAPU32);
      h.push(Y);
      const N = ke(j, Float64Array, G.HEAPF64);
      return h.push(N), {
        keysPtr: Y,
        valuesPtr: N,
        size: R.length
      };
    }, d = T(m.elasticities), L = T(m.areas), x = T(m.momentsOfInertiaZ), X = T(m.momentsOfInertiaY), ne = T(m.shearModuli), A = T(m.torsionalConstants), oe = T(m.thicknesses), M = T(m.poissonsRatios), le = T(m.shearAreasY), ce = T(m.shearAreasZ), pe = G._malloc(4);
    h.push(pe);
    const de = G._malloc(4);
    h.push(de);
    const Z = G._malloc(4);
    h.push(Z);
    const re = G._malloc(4);
    h.push(re);
    const fe = G._malloc(4);
    h.push(fe);
    const v = G._malloc(4);
    h.push(v), G._didactic_solve(g, f.length, C, W.length, q, p.length, $, ee, te.length, S, _, w.length, d.keysPtr, d.valuesPtr, d.size, L.keysPtr, L.valuesPtr, L.size, x.keysPtr, x.valuesPtr, x.size, X.keysPtr, X.valuesPtr, X.size, ne.keysPtr, ne.valuesPtr, ne.size, A.keysPtr, A.valuesPtr, A.size, oe.keysPtr, oe.valuesPtr, oe.size, M.keysPtr, M.valuesPtr, M.size, le.keysPtr, le.valuesPtr, le.size, ce.keysPtr, ce.valuesPtr, ce.size, pe, de, Z, re, fe, v);
    const I = G.HEAPU32[pe / 4], se = G.HEAPU32[de / 4], Q = G.HEAPU32[Z / 4], ve = G.HEAPU32[re / 4], me = G.HEAPU32[fe / 4], _e = G.HEAPU32[v / 4], k = I && se > 0 ? Array.from(new Float64Array(G.HEAPF64.buffer, I, se)) : [], F = Q && ve > 0 ? Array.from(new Float64Array(G.HEAPF64.buffer, Q, ve)) : [], J = me && _e > 0 ? Array.from(new Float64Array(G.HEAPF64.buffer, me, _e)) : [];
    return I && h.push(I), Q && h.push(Q), me && h.push(me), h.forEach((ie) => G._free(ie)), ct(k, F, J, f.length, p.length);
  };
  function ct(f, p, a, m, h) {
    const g = m * 6, W = [];
    if (f.length > 0) {
      const w = f[0], O = [];
      for (let S = 0; S < w; S++) O.push(f[1 + S]);
      for (let S = 0; S < w; S++) {
        let _ = O[S];
        const T = f[_++], d = f[_++], L = f[_++], x = L * L, X = Xe(f.slice(_, _ + x), L);
        _ += x;
        const ne = Xe(f.slice(_, _ + x), L);
        _ += x;
        const A = Xe(f.slice(_, _ + x), L);
        _ += x;
        const oe = Xe(f.slice(_, _ + 9), 3);
        _ += 9;
        const M = f[_++], le = f[_++], ce = f[_++], pe = f[_++], de = f[_++], Z = f[_++], re = f[_++], fe = f[_++], v = f[_++], I = f[_++], se = f[_++];
        W.push({
          index: T,
    ...
    if (a.length > 0) {
      let w = 0;
      const O = a[w++];
      q = a.slice(w, w + O), w += O, te = a.slice(w, w + O), w += O, V = a.slice(w, w + O), w += O;
      const S = a[w++];
      $ = a.slice(w, w + S).map(Math.round), w += S;
      const _ = a[w++];
      ee = a.slice(w, w + _).map(Math.round);
    }
    return {
      nNodes: m,
      nElements: h,
  ...
  function ke(f, p, a) {
    const m = new p(f), h = G._malloc(m.length * m.BYTES_PER_ELEMENT);
    return a.set(m, h / m.BYTES_PER_ELEMENT), h;
  }
})();
export {
