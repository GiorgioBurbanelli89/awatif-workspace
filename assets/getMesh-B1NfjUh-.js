...
let __tla = (async () => {
  ...
  (function(n, t) {
    var o = function() {
      ...
      return typeof __filename < "u" && (s = s || __filename), function(r) {
        ...
        var q, N, G, z;
        x ? (d ? v = K.dirname(v) + "/" : v = __dirname + "/", q = function(i, a) {
        ...
        var ie = 65536, D, H, T;
        function Pe(e) {
          D = e, r.HEAP8 = new Int8Array(e), r.HEAP16 = new Int16Array(e), r.HEAP32 = T = new Int32Array(e), r.HEAPU8 = H = new Uint8Array(e), r.HEAPU16 = new Uint16Array(e), r.HEAPU32 = new Uint32Array(e), r.HEAPF32 = new Float32Array(e), r.HEAPF64 = new Float64Array(e);
        }
  ...
  const O = Ke(fr), ur = "/awatif-workspace/assets/triangle-CCJHBrBP.wasm";
  await O.init(ur);
